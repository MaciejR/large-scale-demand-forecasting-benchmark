...
Table~\ref{tab:t59}.  The v1.4 matched-panel paired bootstrap for M5/Rohlik
is reported separately in Table~\ref{tab:sourceb-paired} and in
...
\begin{itemize}[nosep]
  ...
  \item TimesFM~2.5 and TiRex still require matched-panel reruns before
    Source~B can be treated as a complete five-model bootstrap panel.
