...
\subsection{Legacy 100-Series Bootstrap for Source B FM Cells}

Table~\ref{tab:bootstrap-se} reports the legacy 10{,}000-iteration
bootstrap standard error of mean \WAPE{} for the Source~B
...
of \S\ref{sec:metaanalysis}.  These values come from the legacy small-sample workload and are
...
\begin{table}[htbp]
\centering
\caption{Legacy 100-series bootstrap standard error and 95\% CI for
...
\begin{itemize}[nosep]
  ...
  \item TimesFM~2.5 is absent from this legacy 100-series bootstrap table.
    The separate matched-panel repair now covers TimesFM~2.5 on
