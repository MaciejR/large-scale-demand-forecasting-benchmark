...
dataset--horizon cell. The matched-panel bootstrap is summarised in
Table~\ref{tab:sourceb-paired}. The replication bundle contains the full
cell-level estimates, shared bootstrap draws, and covariance tables used for
the paired log-ratio contrasts.
