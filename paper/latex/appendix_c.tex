...
standard error of mean \WAPE{} for each of the 36 Source~B foundation
model cells (4~FMs $\times$ 3 datasets $\times$ 3 horizons). Each
...
(4~FMs $\times$ 3~datasets $\times$ 3~horizons = 36~cells,
...
Median bootstrap SE across all 36 cells: 0.011. Maximum SE: 0.014
