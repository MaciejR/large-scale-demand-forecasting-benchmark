...
and gives a mixed Favorita protocol ranking, and (iii) the legacy Favorita
\texttt{direct\_scaled} run should not be used as inferential evidence.
...
The matched-panel repair recomputes the M5/Rohlik/Favorita LightGBM protocol
