...
7  & Methods      & Search strategy                                   & \S3.1, \ref{app:search} \\
8  & Methods      & Selection process                                 & \S3.1 \\
9  & Methods      & Data collection process                           & \S3.2 \\
10 & Methods      & Data items                                        & \S3.2 (Table~3.1) \\
11 & Methods      & Study risk of bias assessment                     & \S3.4, \ref{app:threats} \\
12 & Methods      & Effect measures                                   & \S3.4 (log-ratio convention box) \\
13 & Methods      & Synthesis methods                                 & \S3.4 \\
14 & Methods      & Reporting bias assessment                         & \S8 (limitations) \\
15 & Methods      & Certainty assessment                              & \S6 and \ref{app:sensitivity} \\
16 & Results      & Study selection                                   & \S4 (PRISMA flow) \\
17 & Results      & Study characteristics                             & \S4, \ref{app:extraction} \\
