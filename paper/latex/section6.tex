...
The mechanism is that FMs produce well-calibrated predictive
distributions (trained on probabilistic losses at scale); their point
forecasts (median or mean of that distribution) are also significantly
better but the advantage is attenuated relative to distributional
metrics.
