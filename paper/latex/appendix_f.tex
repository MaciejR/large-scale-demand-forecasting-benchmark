...
\begin{enumerate}
  ...
  \item \textbf{Local run covers models up to 120\,M params.}
    TimesFM~2.5 (200\,M) and Moirai~2.0-Large (305\,M) cannot
    be run locally (Python version and memory constraints,
    respectively) and are represented only by Source~A. The four
    local models (Chronos-Bolt-Tiny 9\,M, Moirai~2.0-Small 11\,M,
    TiRex 35\,M, Chronos-2 120\,M) span an order of magnitude in
    scale, partially mitigating the previous limitation of
    testing only sub-35\,M models.
