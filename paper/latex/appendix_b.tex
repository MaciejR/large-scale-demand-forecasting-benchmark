...
Total auditable query families: 25 across three retained source channels
(Google Scholar/web, arXiv, and Semantic Scholar).  The PRISMA-informed flow
uses 150 identified database/web records and 120 records after duplicate
removal.  The hand-documented candidate-paper table in the machine-readable
protocol contains 49 candidate papers; this table is a source map for
extraction, not the PRISMA deduplicated screening denominator.
