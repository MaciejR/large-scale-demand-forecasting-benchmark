...
Total auditable query families: 25.  The PRISMA flow uses 150 identified
records and 120 records after duplicate removal.  The hand-documented
candidate-paper table in the machine-readable protocol contains 49 candidate
papers; this table is a source map for extraction, not the PRISMA
deduplicated screening denominator.
