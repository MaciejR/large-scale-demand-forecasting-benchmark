...
REQUIRED_FILES = {
    ...
    "replication/analysis/figures/source_b_m5_stratified_chronos_cell_summary.csv",
    "replication/analysis/figures/source_b_m5_stratified_chronos_contrasts.csv",
    "replication/analysis/figures/source_b_m5_stratified_panel_composition.csv",
