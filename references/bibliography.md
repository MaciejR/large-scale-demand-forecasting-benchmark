...
Makridakis, S., Spiliotis, E., & Assimakopoulos, V. (2022). Statistical, machine learning and deep learning forecasting methods: Comparisons and ways forward. *International Journal of Forecasting, 38*(3), 975–994.

Hyndman, R. J., & Athanasopoulos, G. (2021). *Forecasting: Principles and Practice* (3rd ed.). OTexts.

Montero-Manso, P., Athanasopoulos, G., Hyndman, R. J., & Talagala, T. S. (2020). FFORMS: Feature-based forecast model averaging. *International Journal of Forecasting, 36*(1), 86–92.
...
Bandara, K., Bergmeir, C., & Smyl, S. (2020). Forecasting across time series databases using recurrent neural networks on groups of similar series. *Expert Systems with Applications, 140*, 112896.
...
Liu, Y., et al. (2024). iTransformer: Inverted transformers are effective for time series forecasting. *Proceedings of the AAAI Conference on Artificial Intelligence*.
...
Seeger, M., et al. (2016). Bayesian intermittent demand forecasting for large inventories. *Advances in Neural Information Processing Systems*.
